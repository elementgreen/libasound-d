...
alias snd_seq_type_t = _snd_seq_type;
...
alias snd_seq_system_info_t = _snd_seq_system_info;

size_t snd_seq_system_info_sizeof ();
/** allocate a #snd_seq_system_info_t container on stack */
extern (D) auto snd_seq_system_info_alloca(T)(auto ref T ptr)
{
...
alias snd_seq_client_info_t = _snd_seq_client_info;
...
alias snd_seq_client_type_t = snd_seq_client_type;

size_t snd_seq_client_info_sizeof ();
/** allocate a #snd_seq_client_info_t container on stack */
extern (D) auto snd_seq_client_info_alloca(T)(auto ref T ptr)
{
    return __snd_alloca(ptr, snd_seq_client_info);
}
...
alias snd_seq_client_pool_t = _snd_seq_client_pool;

size_t snd_seq_client_pool_sizeof ();
/** allocate a #snd_seq_client_pool_t container on stack */
extern (D) auto snd_seq_client_pool_alloca(T)(auto ref T ptr)
{
    return __snd_alloca(ptr, snd_seq_client_pool);
}
...
alias snd_seq_port_info_t = _snd_seq_port_info;
...
extern (D) auto snd_seq_port_info_alloca(T)(auto ref T ptr)
{
    return __snd_alloca(ptr, snd_seq_port_info);
}
...
alias snd_seq_port_subscribe_t = _snd_seq_port_subscribe;

size_t snd_seq_port_subscribe_sizeof ();
/** allocate a #snd_seq_port_subscribe_t container on stack */
extern (D) auto snd_seq_port_subscribe_alloca(T)(auto ref T ptr)
{
    return __snd_alloca(ptr, snd_seq_port_subscribe);
}
...
alias snd_seq_query_subscribe_t = _snd_seq_query_subscribe;
...
extern (D) auto snd_seq_query_subscribe_alloca(T)(auto ref T ptr)
{
    return __snd_alloca(ptr, snd_seq_query_subscribe);
}
...
alias snd_seq_queue_info_t = _snd_seq_queue_info;
/** queue status container */
struct _snd_seq_queue_status;
alias snd_seq_queue_status_t = _snd_seq_queue_status;
/** queue tempo container */
struct _snd_seq_queue_tempo;
alias snd_seq_queue_tempo_t = _snd_seq_queue_tempo;
/** queue timer information container */
struct _snd_seq_queue_timer;
alias snd_seq_queue_timer_t = _snd_seq_queue_timer;
...
extern (D) auto snd_seq_queue_info_alloca(T)(auto ref T ptr)
{
    return __snd_alloca(ptr, snd_seq_queue_info);
}
...
extern (D) auto snd_seq_queue_status_alloca(T)(auto ref T ptr)
{
    return __snd_alloca(ptr, snd_seq_queue_status);
}
...
extern (D) auto snd_seq_queue_tempo_alloca(T)(auto ref T ptr)
{
    return __snd_alloca(ptr, snd_seq_queue_tempo);
}
...
extern (D) auto snd_seq_queue_timer_alloca(T)(auto ref T ptr)
{
    return __snd_alloca(ptr, snd_seq_queue_timer);
}
...
alias snd_seq_remove_events_t = _snd_seq_remove_events;
...
extern (D) auto snd_seq_remove_events_alloca(T)(auto ref T ptr)
{
